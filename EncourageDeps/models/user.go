...
func RegisterUser(username, password string) error {
	...
	log.Print("register username  :", username)
	if err != nil {
		return err
	}
...
func GetUsername(userNumber string) (string, error) {
	log.Printf("Ran GetUserName fuction")
	return client.HGet(userNumber, "username").Result()
}
